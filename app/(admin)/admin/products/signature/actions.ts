...
// Fetch signature collection products for table
export async function fetchSignatureCollectionTable(): Promise<FetchSignatureCollectionResult> {
  try {
    ...
    console.error("Error fetching signature collection for table:", error);
    return {
      success: false,
      error:
...
export async function toggleProductPublish(
  ...
  try {
    ...
    revalidatePath("/admin/products/signature");
