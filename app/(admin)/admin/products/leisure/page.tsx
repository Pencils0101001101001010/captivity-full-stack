...
const leisureTheme: ThemeColors = {
  primary: "#0369A1", // Ocean blue
  hover: "#0284C7", // Light ocean blue
  text: "#F0F9FF", // Sky blue
  accent: "#075985", // Deep ocean blue
};

const LeisureTablePage = () => {
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        {/* Header Section */}
        <div className="mb-8 rounded-lg bg-gradient-to-br from-sky-800 via-sky-700 to-blue-900 p-6 shadow-lg">
          {/* Title and Icons */}
          <div className="flex items-center justify-center space-x-4 mb-8">
            <div className="relative">
              <FaBaseballBall className="h-8 w-8 text-sky-100" />
              <div className="absolute -inset-1 bg-white/20 rounded-full blur-sm" />
            </div>
            <h1 className="text-4xl font-bold tracking-tight text-white drop-shadow-md">
              Leisure Collection 2024
            </h1>
            <div className="relative">
              <TbBallBaseball className="h-8 w-8 text-sky-100" />
              <div className="absolute -inset-1 bg-white/20 rounded-full blur-sm" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <StatsCard
              title="New Arrivals"
              value="24 Products"
              icon={<BaseballIcon className="h-6 w-6 text-sky-600" />}
            />
            <StatsCard
        ...
        <div className="rounded-xl bg-white p-6 shadow-lg ring-1 ring-black/5">
          <ProductsPage themeColors={leisureTheme} />
        </div>
      </div>
    </div>
  );
  ...
  <div className="relative overflow-hidden rounded-lg bg-white p-6 shadow-md transition-all hover:shadow-lg">
    <div className="absolute right-0 top-0 h-24 w-24 translate-x-8 -translate-y-8 transform">
      <div className="absolute inset-0 opacity-10">
        <FaBaseballBall className="h-full w-full text-sky-800" />
      </div>
    </div>
    <div className="relative">
      ...
      <div className="mt-4 text-2xl font-semibold text-sky-800">{value}</div>
    </div>
  </div>
);
...
export default LeisureTablePage;
