...
import { fetchFashionCollections } from "./actions";
...
const FashionTable = () => {
  ...
  const loadFashionProducts = async (query: string = "") => {
    setIsLoading(true);
    const result = await fetchFashionCollections(undefined, query);
    if (result.success) {
      setFashionProducts(result.data);
      setError(null);
    } else {
    ...
    <div>
      <div className="overflow-x-auto mt-4">
        <div className="m-6 flex space-x-9 items-center">
          <h1 className="text-2xl font-extrabold">FASHION COLLECTION</h1>
          <div className="w-52">
