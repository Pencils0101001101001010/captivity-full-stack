...
// Fetch african collection products for table
export async function fetchBaseballCollectionTable(): Promise<FetchBaseballCollectionResult> {
  try {
    ...
    console.error("Error fetching baseball collection for table:", error);
    return {
      success: false,
      error:
...
export async function toggleProductPublish(
  ...
  try {
    ...
    revalidatePath("/admin/products/african");
    revalidatePath("/customer/shopping/product_categories/african");
