...
// Fetch sport collection products for table
export async function fetchSportCollectionTable(): Promise<FetchSportCollectionResult> {
  try {
    ...
    console.error("Error fetching sport collection for table:", error);
    return {
      success: false,
      error:
...
export async function toggleProductPublish(
  ...
  try {
    ...
    revalidatePath("/admin/products/sport");
