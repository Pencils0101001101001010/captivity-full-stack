...
// Fetch fashion collection products for table
export async function fetchFashionCollectionTable(): Promise<FetchFashionCollectionResult> {
  try {
    ...
    console.error("Error fetching fashion collection for table:", error);
    return {
      success: false,
      error:
...
export async function toggleProductPublish(
  ...
  try {
    ...
    revalidatePath("/admin/products/fashion");
