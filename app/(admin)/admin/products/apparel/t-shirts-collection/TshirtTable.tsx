...
import { fetchTshirtsCollections } from "./actions";
...
const TshirtTable = () => {
  ...
  useEffect(() => {
    const loadTshirtProducts = async () => {
      setIsLoading(true);
      const result = await fetchTshirtsCollections(undefined, searchQuery);
      if (result.success) {
        setTShirtProducts(result.data);
        setError(null);
      } else {
  ...
  return (
    <div className="overflow-x-auto">
      <div className="m-6 flex space-x-9 items-center">
        <h1 className="text-2xl font-extrabold">T-SHIRT COLLECTION</h1>
        <div className="w-52">
