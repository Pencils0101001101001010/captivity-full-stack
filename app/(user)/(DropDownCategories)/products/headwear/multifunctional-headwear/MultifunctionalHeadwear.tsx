...
import useMultifunctionalHeadwear from "./useMultifunctionalHeadwear";
...
const MultifunctionalHeadwearProductList: React.FC = () => {
  const { products, loading, error } = useMultifunctionalHeadwear();
  ...
  return (
    <section className="container mx-auto my-8">
      <HeroSection
        ...
        categoryName="Multifunctional-Headwear"
      />
      ...
      <div className="flex flex-col md:flex-row gap-6 relative">
        ...
        <main className="w-full md:w-3/4 lg:w-4/5">
          <div className="flex items-center justify-between w-full mb-4">
            <h4>New in Multifunctional-headwear...</h4>
            <div className="w-[200px] max-w-sm">
              <Input
                type="text"
                placeholder="Search MultifunctionalHeadwear..."
                value={searchQuery}
