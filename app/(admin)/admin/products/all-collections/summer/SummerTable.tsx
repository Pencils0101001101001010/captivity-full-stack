...
const SummerTable = () => {
  ...
  useEffect(() => {
    const loadSummerProducts = async () => {
      setIsLoading(true);
      const result = await fetchSummerCollections(undefined, searchQuery);
      if (result.success) {
        setSummerProducts(result.data);
        setError(null);
      } else {
  ...
  return (
    <div className="overflow-x-auto">
      <div className="m-6 flex space-x-9 items-center">
        <h1 className="text-2xl font-extrabold">SUMMER COLLECTION</h1>
        <div className="w-52">
