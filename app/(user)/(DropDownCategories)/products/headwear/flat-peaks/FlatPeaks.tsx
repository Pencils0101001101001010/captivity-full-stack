...
import useFlatPeaks from "./useFlatPeaks";
...
const FlatPeaksProductList: React.FC = () => {
  const { products, loading, error } = useFlatPeaks();
  ...
  return (
    <section className="container mx-auto my-8">
      <HeroSection
        ...
        categoryName="Flat Peaks"
      />

      <div className="flex flex-col md:flex-row gap-6 relative">
        {/* Updated sidebar with overflow-x-hidden */}
...
// Added max-h-[calc(100vh-2rem)] to ensure the sidebar doesn't exceed viewport height
// Added overflow-y-auto to make the sidebar scrollable if content is too long
// Wrapped the SideMenu in a div with the sticky properties