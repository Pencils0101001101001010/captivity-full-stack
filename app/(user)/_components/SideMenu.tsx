...
const SideMenu = () => {
  return (
    <div className="space-y-5 md:mr-10 lg:mr-10 min-h-[500px] xl:mr-10 xl:ml-20 lg:ml-20 md:ml-20">
      <aside className="w-[230px] mb-0 hidden lg:block top-0 border-2 -ml-10 border-gray-200 pl-4 pb-4 pt-4">
      ...
      <aside className="w-[230px]  hidden lg:block top-0 border-2 -ml-10 border-gray-200 pl-4 pb-4 pt-4">
        <ul className="menu  text-gray-700 ">
